...
use crate::components::database::{
    database::Database, record::Record, schema::TableSchema, value_type::ValueType,
};
...
pub struct Transaction {
    ...
    pub pending_updates: Vec<(String, u64, HashMap<String, ValueType>)>, // (table, record_id, updates)
